...
const ManagerStatsChart = React.memo(() => {
  ...
  return (
    <div className="mt-12 space-y-12">
      <h2 className="text-xl font-semibold mb-4">Aperçus des statistiques du manager</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Graphique circulaire */}
        <div className="max-h-96 md:h-96 w-full">
          <Pie data={pieData} options={options} />
        </div>
        {/* Nouveau graphique des produits vendus par mois */}
        <div className="max-h-96 md:h-96 w-full">
...
export default ManagerStatsChart;
