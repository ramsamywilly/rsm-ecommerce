...
const TimelineStep = ({ step, order, isCompleted, isCurrent, isLastStep, icon, description }) => {
    // Correction de la syntaxe pour les classes avec interpolation de variables
    ...
    return (
        <li className='relative mb-6 sm:mb-0 sm:pl-10'>
            <div className='flex items-center'>
                {/* Correction de la syntaxe d'interpolation des classes CSS */}
                <div className={`z-10 flex items-center justify-center w-6 h-6 
                    ...
                    {/* Correction de la syntaxe pour l'icône */}
            ...
            <div className= 'mt-3 sm:pe-8'>
                ...
                <time className= 'block mb-2 text-sm font-normal leading-nome text-gray-400'>
